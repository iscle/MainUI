...
public class CanGolfRzcReportsView {
    /*public static final String TAG = "CanGolfRzcReportsView";
    ...
    public CanGolfRzcReportsView(Activity activity) {
        super(activity);
    }
    ...
    public void InitUI() {
        ...
        for (int i = 0; i < this.mItemReports.length; i++) {
            this.mItemReports[i] = new CanItemTextBtnList(getActivity(), 0);
